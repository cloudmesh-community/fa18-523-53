...
All the partitions for a topic is often termed as Stream. +@fig:topicWithMultiplePartitions [@www-kafkaGuide] describes four partitions of a single topic.
