...
![A consumer group reading from a topic[@www-kafkaGuide]](images/kafkaConsumerGroup.png){#Figure2: A Consumer group reading from a topic}
...
![Representation of partitions in a cluster[@www-kafkaGuide]](images/kafkaBrokers.png){#Figure3: Representation of partitions in a cluster}
